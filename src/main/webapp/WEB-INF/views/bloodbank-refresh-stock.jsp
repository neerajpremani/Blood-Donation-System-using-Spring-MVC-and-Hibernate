...
<head>
<meta charset="UTF-8">
<title>Blood Donation Current Stock</title>
...
<body>
	...
	<div class="container">
		...
		<a style="font-size: 20px; color: red; padding-left:850px;"
		href="${pageContext.request.contextPath}/existingUser/main-bloodbank/downloadPDF/${sessionScope.userName}">Download
		PDF</a>
	<table class="table">
		<tr >
			<th>Blood Type</th>
